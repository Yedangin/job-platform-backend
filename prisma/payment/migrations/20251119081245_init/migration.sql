...
-- AddForeignKey
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_toss_order_id_fkey" FOREIGN KEY ("toss_order_id") REFERENCES "deposits"("id") ON DELETE SET NULL ON UPDATE CASCADE;
