...
export const KSIC_MAPPING: ReadonlyArray<KsicMappingEntry> = [
  ...
  // === 건물 관리 / Building Management ===
  {
    ...
    nameKo: '건물 경비원',
    nameEn: 'Building Security Guard',
    ksicCode: 'N',
    ksicName: '사업시설 관리 및 지원',
    isSimpleLabor: true,
    isEntertainment: false,
  ...
  // === 공공이익 제한 직종 (F-4 금지) / Public Interest Restricted Jobs (F-4 blocked) ===
  // 법무부 고시 — 공공이익에 반하는 취업제한 업종
  // MOJ Notice — Employment restricted industries against public interest
  {
    jobCategoryCode: 'SKIN_CARE',
    nameKo: '피부관리사',
    nameEn: 'Skin Care Specialist',
    ksicCode: 'S',
    ksicName: '기타 개인 서비스업',
    isSimpleLabor: false,
    isEntertainment: false,
