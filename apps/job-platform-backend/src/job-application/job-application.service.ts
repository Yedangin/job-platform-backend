...
export interface GetMyApplicationsQueryDto {
  status?: string;
  page?: number;
  limit?: number;
}

export interface GetJobApplicationsQueryDto {
  status?: string;
  page?: number;
  limit?: number;
}
...
export interface SelectInterviewSlotDto {
  slotId: string;
}

export interface ProposeNewTimeDto {
  proposedTime: string;
  proposedBy?: 'EMPLOYER' | 'APPLICANT';
  note?: string;
}

export interface SendResultNotificationDto {
