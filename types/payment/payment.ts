...
export interface AllDepositsWithMetaResponse {
  data: Deposit[];
  meta: PaginationMeta | undefined;
}
...
export interface PaymentServiceClient {
  ...
  getAllDeposits(request: GetAllDepositsRequest): Observable<AllDepositsWithMetaResponse>;
...
export interface PaymentServiceController {
  ...
  ): Promise<AllDepositsWithMetaResponse> | Observable<AllDepositsWithMetaResponse> | AllDepositsWithMetaResponse;
